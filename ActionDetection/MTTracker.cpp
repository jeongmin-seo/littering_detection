...
************************************************************************/
KeyPointsSet CMTTracker::ReadKeypoints(const std::string _strFilePath)
{
...
/************************************************************************
 ...
 Return Values:
	- None
************************************************************************/
void CMTTracker::BackwardTracking(std::vector<CDetectedObject> &_vecDetectedObjects)
{
	//---------------------------------------------------
...
/************************************************************************
 ...
 Return Values:
	- None
************************************************************************/
void CMTTracker::ForwardTracking(hj::TrackletPtQueue &_queueTracklets)
{
...
/************************************************************************
 ...
 Return Values:
	- None
************************************************************************/
void CMTTracker::DetectionToTrackletMatching(
